...
//   const { diagnosticCenter } = useAuth(); // you might still use this if needed
...
//       try {
//         // Notice: No filter on diagnostic_center_id -> .eq('diagnostic_center_id', diagnosticCenter.id) removed
...
//     try {
//       // We only update the pregnant_women table
//       const updatePayload = {
//         name: formData.name,
//         age: formData.age,
...
//                     {/* Husband's Name */}
//                     <div>
//                       <span className="opacity-75">Husband:</span>{' '}
//                       {editMode ? (
//                         <input
//                           type="text"
//                           name="husband_name"
...
//                             {proc.performing_doctor
//                               ? proc.performing_doctor.name
//                               : 'N/A'}
//                           </p>
//                           <p>
//                             <span className="font-semibold">Referring Doctor:</span>{' '}
//                             {proc.referring_doctor
//                               ? proc.referring_doctor.name
//                               : 'N/A'}
//                           </p>
//                           <p>
